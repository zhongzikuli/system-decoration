        ...
        <div class="row">
            ...
            <div class="col-sm-12 text-right">
               <%-- <div class="form-inline">
                    <a class="btn btn-sm btn-info" id="firstVisitBackList">返回列表</a>
                </div>--%>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-sm-12 text-left padding-r-30">
                        <div class="form-group">
                            <c:if test="${order.creditQueryTongdun ne 1}">
                                <shiro:hasPermission name="firstVisit:queryTDData">
                                    <button class="btn btn-primary btn-xs query-credit-btn" type="button">征信查询</button>
                                </shiro:hasPermission>
                            </c:if>
                                <shiro:hasPermission name="firstVisit:tdDataDetail">
                                    <button type="button" class="btn btn-info btn-xs detail-credit-btn">查看详情
                                    </button>
                                </shiro:hasPermission>
                                <shiro:hasPermission name="firstVisit:tdDataExport">
                    ...
                    <form id="firstVisitForm">
                        <div class="form-horizontal">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div>
                                    <textarea class="form-control" id="firstVisitSuggest" tip="不能为空，请重新输入"
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-right padding-r-30">
                                    <shiro:hasPermission name="firstVisit:changeAudit">
                                        <a class="btn btn-primary btn-sm" id="firstVisitChangeAuditBtn">换审核</a>
                                    </shiro:hasPermission>

                                    <shiro:hasPermission name="firstVisit:audit">
                                        <a class="btn btn-danger btn-sm" id="firstVisitRefuseOrderBtn"
                                           data-status="-4">拒单</a>
                                    </shiro:hasPermission>

                                    <shiro:hasPermission name="firstVisit:audit">
                                        <a class="btn btn-info btn-sm" id="firstVisitBackApplyBtn"
                                           data-status="-2">退回申请</a>
                                    </shiro:hasPermission>

                                    <shiro:hasPermission name="firstVisit:audit">
                                        <a class="btn btn-info btn-sm" id="firstVisitOrderApplyBtn"
                                           data-status="8">退回到银行审批</a>
                                    </shiro:hasPermission>

                                    <shiro:hasPermission name="firstVisit:audit">
                                        <a class="btn btn-primary btn-sm" id="firstVisitSaveBtn"
                                           data-status="12">保存</a>
                                    </shiro:hasPermission>

                                    <shiro:hasPermission name="firstVisit:audit">
                                        <a class="btn btn-success btn-sm" id="firstVisitAgreeBtn"
                                           data-status="16">同意</a>
                                    </shiro:hasPermission>
                                </div>
                            </div>
...
<script type="text/javascript" src="${ctx}/js/mine/decoreteLoan/firstVisit/firstVisitDetail.js"></script>
</html>
