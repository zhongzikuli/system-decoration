...
<div class="main-wrapper flex">
    <div class="mod_header">
        <div id="hiddenForm">
            <input type="hidden" name="firstVisitOrderStatus" value="${paramMap.firstVisitOrderStatus}"/>
        ...
        <form id="pagerForm" action="${ctx}/firstVisit/firstVisitQuery.action" method="post">
            <%@include file="/WEB-INF/views/include/pageForm.jsp" %>
            <div class="row">
                <div class="col-sm-2">
                    <%--<c:if test="${paramMap.firstVisitOrderStatus == 12}">--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <select class="form-control" id="search-style" name="firstVisitOrderStatus">
                                            <option value="0">全部</option>
                                            <option value="12"
                                                    <c:if test="${paramMap.firstVisitOrderStatus == 12}">selected</c:if>>
                                                未上门
                                            </option>
                                            <option value="16"
                                                    <c:if test="${paramMap.firstVisitOrderStatus == 16}">selected</c:if>>
                                                已上门
                                            </option>
                                        </select>
                                    </div>
                    ...
                    <tr>
                       ...
                       <%-- </c:if>--%>
                        ...
                        <td class="btn-cel">
                            ...
                            <shiro:hasPermission name="firstVisit:view">
                                <a data-id="${item.id}" data-title="${item.realName}"
...
<script type="text/javascript" src="${ctx}/js/mine/decoreteLoan/firstVisit/firstVisitList.js"></script>
</html>
