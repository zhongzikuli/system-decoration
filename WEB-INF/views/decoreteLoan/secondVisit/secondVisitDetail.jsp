    ...
    <div class="row">
        ...
        <div class="col-sm-12 text-right">
           <%-- <div class="form-inline">
                <a class="btn btn-sm btn-info" id="secondVisitBackList">返回列表</a>
            </div>--%>
        </div>
    </div>
</div>
                ...
                <div class="col-sm-12 text-left padding-r-30">
                    <div class="form-group">
                        <c:if test="${order.creditQueryTongdun ne 1}">
                            <shiro:hasPermission name="secondVisit:queryTDData">
                                <button class="btn btn-primary btn-xs query-credit-btn" type="button">征信查询</button>
                            </shiro:hasPermission>
                        </c:if>
                            <shiro:hasPermission name="secondVisit:tdDataDetail">
                ...
                <form id="firstLendingForm">
                    <div class="form-horizontal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="money" disabled id="search-money" value='<sl:format type="number" show="${firstLending.money}" pattern="#,##0.00"/>'>

                            </div>
                            <label class="col-sm-1 control-label">贷款额(元):</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control"  disabled name="loanMoney" id="search-loan_money" value='<sl:format type="number" show="${firstLending.loanMoney}" pattern="#,##0.00"/>' >
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <label class="control-label" disabled>
                                    <fmt:formatDate value="${order.firstLendingHandleTime}" pattern="yyyy-MM-dd HH:mm"/>
                                </label>
                            </div>
                            <div class="col-sm-2"></div>
                        </div>
                ...
                <form id="secondVisitForm">
                    <div class="form-horizontal">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div>
                                    <textarea class="form-control" id="secondVisitSuggest" tip="不能为空，请重新输入"
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-right padding-r-30">
                                <shiro:hasPermission name="secondVisit:changeAudit">
                                    <a class="btn btn-primary btn-sm" id="secondVisitChangeAuditBtn">换审核</a>
                                </shiro:hasPermission>

                                <shiro:hasPermission name="secondVisit:audit">
                                    <a class="btn btn-danger btn-sm" id="secondVisitRefuseOrderBtn"
                                       data-status="-4">拒单</a>
                                </shiro:hasPermission>

                                <shiro:hasPermission name="secondVisit:audit">
                                    <a class="btn btn-info btn-sm" id="secondVisitBackApplyBtn"
                                       data-status="-2">退回申请</a>
                                </shiro:hasPermission>

                                <shiro:hasPermission name="secondVisit:audit">
                                    <a class="btn btn-info btn-sm" id="secondVisitOrderApplyBtn"
                                       data-status="16">退回到一次放款</a>
                                </shiro:hasPermission>

                                <shiro:hasPermission name="secondVisit:audit">
                                    <a class="btn btn-primary btn-sm" id="secondVisitSaveBtn"
                                       data-status="20">保存</a>
                                </shiro:hasPermission>

                                <shiro:hasPermission name="secondVisit:audit">
                                    <a class="btn btn-success btn-sm" id="secondVisitAgreeBtn"
                                       data-status="24">同意</a>
                                </shiro:hasPermission>
                            </div>
                        </div>
...
<script type="text/javascript" src="${ctx}/js/mine/decoreteLoan/secondVisit/secondVisitDetail.js"></script>
