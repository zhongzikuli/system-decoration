...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/loanDetail/query.action" method="post" style="margin:0;">
        <%@include file="/WEB-INF/views/include/pageForm.jsp"%>
        <div class="row">
            <div class="col-sm-1">
                <shiro:hasPermission name="reportManager:exportApplyLoanDetailList">
                     <%--<a data-toggle="modal" type="button" class="btn btn-info btn-sm" onclick="exportApplyLoanDetailList()">导出申请贷款明细</a>--%>
                    <a data-toggle="modal" type="button" class="btn btn-info btn-sm" onclick="exportApplyLoanDetailListExcel('/loanDetail/exportApplyLoanDetailList.action')">导出申请贷款明细</a>
                </shiro:hasPermission>
            </div>
                ...
                <div class="form-inline">
                    ...
                    <div class="form-group">
                        <label class="control-label label">搜索:</label>
                         <input id="keyword" type="text" class="form-control" placeholder="请输入客户姓名或身份证号或订单编号" name="keyword" value="${keyword}" onkeyup="value=value.replace(/\s/g,'')">
                    </div>
                    <div class="form-group" id="date-time">
                        <label class="control-label label">申请时间:</label>
                            <div class="input-group">
                                <input type="text" class="form-control w-120" name="startDate" id="startDate" value="${startDate}" />
                                <span class="input-group-addon">到</span> <input type="text" class="form-control w-120" name="endDate" id="endDate" value="${endDate}" />
                            </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="table-responsive full-height">
            <table class="table table-hover table-height table-striped">
                ...
                <tr>
                    ...
                    <th style="width:8%;">贷款年限(年)</th>
                    <th style="width:8%;">贷款额(元)</th>
                    <th style="width:8%;">房产面积(㎡)</th>
                    <th style="width:8%;">房产地址</th>
                    <th style="width:8%;">房屋价值（万元）</th>
                ...
                <c:forEach var="item" items="${pageBean.recordList}" varStatus="st">
                    <tr>
                        <td><input type="checkbox" class="checkOne" name="businessOrderId" value="${item.acceptId}"></td>
                        ...
                        <td class="cel">
                            <fmt:formatNumber type="number" value="${item.currentPrice/10000}"
                                              pattern="#,##0.00"/></td>
                        </td>
                        <td >${item.depName}</td>
                        ...
                        <td class="btn-cel">
                            <shiro:hasPermission name="bankHandle:detail">
...
<script type="text/javascript" src="${ctx}/js/mine/decoreteLoan/reportManager/reportManager.js"></script>
<script type="text/javascript" src="${ctx}/js/mine/decoreteLoan/reportManager/list.js"></script>
</html>
