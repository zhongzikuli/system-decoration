...
<div class="main-wrapper flex">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 text-right">
                <%--<div class="form-inline">
                    <a class="btn btn-sm btn-info" id="secondLendingBackList">返回列表</a>
                </div>--%>
            </div>
        </div>
    </div>
    <div class="mod_basic no-border animated">
                    ...
                    <form id="customerInfoForm">
                        <div class="form-horizontal">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" id="card_no" class="form-control" disabled
                                           value="${order.cardNo}">
                                </div>
                    ...
                    <form id="loanInfoForm">
                        <div class="form-horizontal">
                            <div class="row">
                                ...
                                <label class="col-sm-1 control-label"><span class="red">*</span>贷款年限(年):</label>
                                <div class="col-sm-2">
                    ...
                    <div class="col-sm-12 text-left padding-r-30">
                        <div class="form-group">
                            <c:if test="${order.creditQueryTongdun ne 1}">
                                <shiro:hasPermission name="secondLending:queryTDData">
                                    <button class="btn btn-primary btn-xs query-credit-btn" type="button">征信查询</button>
                                </shiro:hasPermission>
                            </c:if>
                            <shiro:hasPermission name="secondLending:tdDataDetail">
                    ...
                    <form id="businessInfoForm">
                        <div class="form-horizontal">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                <textarea class="form-control" disabled maxlength="500"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <label class="control-label" disabled>
                                        <fmt:formatDate value="${order.businessHandleTime}"
                    ...
                    <form id="bankHandleForm">
                        <div class="form-horizontal">
                            ...
                            <div class="row">
                                ...
                                <label class="label-item"><input type="checkbox" value="港澳台居民通行证" class="i-checks"
                                                                 disabled
        ...
        <div class="item-row">
                    ...
                    <form id="firstVisitForm">
                        <div class="form-horizontal">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <label class="control-label" disabled>
                                        <fmt:formatDate value="${order.firstVisitHandleTime}"
                                                        pattern="yyyy-MM-dd HH:mm"/>
                                    </label>
                                </div>
                                <div class="col-sm-2"></div>
                    ...
                    <form id="firstLendingForm">
                        <div class="form-horizontal">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="money" disabled
                                           value='<sl:format type="number" show="${firstLending.money}" pattern="#,##0.00"/>'>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div>
                                    <textarea class="form-control" id="firstLendingSuggest" disabled
                                              rows="8"><c:if
                            ...
                            <div class="row">
                                <label class="col-sm-1 control-label">操作人:</label>
                                <div class="col-sm-3">
                                    <label class="control-label" disabled>${order.firstLendingHandleUsername}</label>
                                </div>
                                <div class="col-sm-2"></div>
                                <label class="col-sm-1 control-label">操作时间:</label>
                                <div class="col-sm-3">
                                    <label class="control-label" disabled>
                                        <fmt:formatDate value="${order.firstLendingHandleTime}"
                                                        pattern="yyyy-MM-dd HH:mm"/>
                                    </label>
                                </div>
                                <div class="col-sm-2"></div>
            ...
            <fieldset>
                <legend>二次上门</legend>
                <div id="secondVisitDiv">
                    <form id="secondVisitForm">
                        <div class="form-horizontal">
                            <div class="row">
                                <label class="col-sm-1 control-label"><span class="red">*</span>审批意见:</label>
                                <div class="col-sm-10">
                                    <div>
                                    <textarea class="form-control" id="secondVisitSuggest" disabled rows="8"><c:if
                                            test="${secondVisit != null}">${secondVisit.suggest}</c:if></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-sm-1 control-label">操作人:</label>
                                <div class="col-sm-3">
                                    <label class="control-label" disabled>${order.secondVisitHandleUsername}</label>
                                </div>
                                <div class="col-sm-2"></div>
                                <label class="col-sm-1 control-label">操作时间:</label>
                                <div class="col-sm-3">
                                    <label class="control-label" disabled>
                                        <fmt:formatDate value="${order.secondVisitHandleTime}"
                                                        pattern="yyyy-MM-dd HH:mm"/>
                                    </label>
                                </div>
                                <div class="col-sm-2"></div>
            ...
            <fieldset>
                <legend>二次放款</legend>
                <div id="secondLendingDiv">
                    <form id="secondLendingForm">
                        <div class="form-horizontal">
                            <div class="row">
                                <label class="col-sm-1 control-label"><span class="red">*</span>放款金额(元):</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="money" id="search-money" disabled value="${secondLending.money}">
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-sm-1 control-label"><span class="red">*</span>放款意见:</label>
                                <div class="col-sm-10">
                                    <div>
                                    <textarea class="form-control" id="secondLendingSuggest" tip="不能为空，请重新输入"
                                              onkeyup="checkLen(1000,this)" rows="8" reg="not_null"><c:if
                                            test="${secondLending != null}">${secondLending.suggest}</c:if></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 text-right padding-r-30">
                                    <shiro:hasPermission name="secondLending:changeAudit">
                                        <a class="btn btn-primary btn-sm" id="secondLendingChangeAuditBtn">换审核</a>
                                    </shiro:hasPermission>

                                    <shiro:hasPermission name="secondLending:audit">
                                        <a class="btn btn-danger btn-sm" id="secondLendingRefuseOrderBtn"
                                           data-status="-4">拒单</a>
                                    </shiro:hasPermission>

                                    <shiro:hasPermission name="secondLending:audit">
                                        <a class="btn btn-info btn-sm" id="secondLendingBackApplyBtn"
                                           data-status="-2">退回申请</a>
                                    </shiro:hasPermission>

                                    <shiro:hasPermission name="secondLending:audit">
                                        <a class="btn btn-info btn-sm" id="secondLendingOrderApplyBtn"
                                           data-status="20">退回到二次上门</a>
                                    </shiro:hasPermission>

                                    <shiro:hasPermission name="secondLending:audit">
                                        <a class="btn btn-primary btn-sm" id="secondLendingSaveBtn"
                                           data-status="24">保存</a>
                                    </shiro:hasPermission>

                                    <shiro:hasPermission name="secondLending:audit">
                                        <a class="btn btn-success btn-sm" id="secondLendingAgreeBtn"
                                           data-status="28">同意</a>
                                    </shiro:hasPermission>
                                </div>
                            </div>
...
<script type="text/javascript" src="${ctx}/js/mine/decoreteLoan/secondLending/secondLendingDetail.js"></script>
</html>
