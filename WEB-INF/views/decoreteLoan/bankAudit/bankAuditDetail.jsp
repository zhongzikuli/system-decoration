    ...
    <div class="row">
        ...
        <div class="col-sm-12 text-right">
            <%--<div class="form-inline">
                <a class="btn btn-sm btn-info" id="bankAuditBackList">返回列表</a>
            </div>--%>
        </div>
    </div>
</div>
                ...
                <form id="bankAuditForm">
                    <div class="form-horizontal">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div>
                                    <textarea class="form-control"   id="bankAuditSuggest" tip="不能为空，请重新输入"
                                              reg="not_null" rows="8"><c:if
                                            test="${bankAudit != null}">${bankAudit.suggest}</c:if></textarea>
                                </div>
                            </div>
                        </div>
                        <c:if test="${bankAudit.orderStatus == 8 }">
                            <div class="row">
                            <div class="col-sm-12 text-right padding-r-30">
                                <shiro:hasPermission name="bankAudit:changeAudit">
                                    <a class="btn btn-primary btn-sm" id="bankAuditChangeAuditBtn">换审核</a>
                                </shiro:hasPermission>

                                <shiro:hasPermission name="bankAudit:audit">
                                    <a class="btn btn-danger btn-sm" id="bankAuditRefuseOrderBtn"
                                       data-status="-4">拒单</a>
                                </shiro:hasPermission>

                                <shiro:hasPermission name="bankAudit:audit">
                                    <a class="btn btn-info btn-sm" id="bankAuditBackApplyBtn"
                                       data-status="-2">退回申请</a>
                                </shiro:hasPermission>

                                <shiro:hasPermission name="bankAudit:audit">
                                    <a class="btn btn-info btn-sm" id="bankAuditOrderApplyBtn"
                                       data-status="4">退回到银行受理</a>
                                </shiro:hasPermission>

                                <shiro:hasPermission name="bankAudit:audit">
                                    <a class="btn btn-primary btn-sm" id="bankAuditSaveBtn"
                                       data-status="8">保存</a>
                                </shiro:hasPermission>

                                <shiro:hasPermission name="bankAudit:audit">
                                    <a class="btn btn-success btn-sm" id="bankAuditAgreeBtn"
                                       data-status="12">同意</a>
                                </shiro:hasPermission>
                            </div>
                        </div>
...
<script type="text/javascript" src="${ctx}/js/mine/decoreteLoan/bankAudit/bankAuditDetail.js"></script>
</html>
